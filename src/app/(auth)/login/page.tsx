    ...
    <main className="min-h-screen bg-slate-50 lg:grid lg:grid-cols-[0.9fr_1.1fr]">
      <section className="relative hidden overflow-hidden bg-slate-950 px-10 py-12 text-white lg:flex lg:flex-col lg:justify-between xl:px-16">
        ...
        <div className="relative max-w-md">
          <p className="mb-5 text-sm font-semibold uppercase tracking-[0.2em] text-emerald-400">Acceso seguro</p>
          <h1 className="text-5xl font-extrabold leading-[0.98] text-white xl:text-6xl">Vuelve a<br />la cancha.</h1>
          <p className="mt-8 max-w-sm text-base leading-7 text-slate-400">Ingresa para continuar con la gestión de tu cancha.</p>
        </div>
      ...
      <section className="flex min-h-screen items-center justify-center px-6 py-12 sm:px-10">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <h2 className="text-3xl font-extrabold text-slate-950">Iniciar sesión</h2>
